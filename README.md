...
Xuunu is a health tracking and performance optimization platform that connects
wearables and medical devices, analyzes health trends, and computes a weekly
biosignature for personalized insights.

## Project Structure

- `client/`: React UI application.
- `server/`: Express API, webhook handlers, and server-side logic.
- `shared/`: Shared schema and type definitions.
- `public/`: Static assets and web manifest.
- `scripts/`: Internal automation scripts.
- `attached_assets/`: Design and branding assets.
...
The biosignature is a personalized performance pattern calculated from 7 days
of health data.
...
This is a private project. For questions or issues, contact the development
team.
...
- [x] Activity logging with photos
- [x] Health device integration (Terra API)
- [x] Biosignature calculation
- [x] Social feed
